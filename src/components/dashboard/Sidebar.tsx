...
// Sidebar content component with better organization
interface SidebarContentProps {
  navigationItems: NavigationItemType[]; // Use NavigationItemType
  pathname: string;
  hasPermission: (permission: NavigationItemType["permission"]) => boolean; // Use Permission
  userRole: UserRole;
}
...
function SidebarContent({
      ...
      notifications: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M15 17h5l-5 5v-5zM4.08 13.601a5.02 5.02 0 015.73-7.882l.47-1.717a6.518 6.518 0 00-7.376 9.599l1.176-.471z"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const groupedItems = useMemo(() => {
    const groups: { [key: string]: NavigationItemType[] } = {
      main: [],
      management: [],
      data: [],
      tools: [],
