...
export default function CommunityGroupsPage() {
  ...
  const groups = [
    ...
    {
      id: 5,
      name: "Toxicology Network",
      description: "Connect with toxicology professionals",
      members: 45,
      category: "Professional",
      privacy: "Public",
      isJoined: false,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Join groups and connect with members who share your interests
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">Available Groups</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white">
            {groups.length}
          </p>
        </div>
        ...
        {filteredGroups.map((group) => (
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              {group.isJoined ? (
                <button className="w-full flex items-center justify-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg dark:bg-gray-700 dark:text-gray-300 cursor-default">
                  <CheckIcon className="h-4 w-4 mr-2" />
                  Joined
                </button>
              ) : (
                <button className="w-full flex items-center justify-center px-4 py-2 bg-[#00B5A5] text-white rounded-lg hover:bg-[#008F82] transition-colors">
